...
png("ex1.png", width = 4, height = 4, units = "in", res = 240)
plot(1,3, 
     frame=FALSE, 
     main="Plot of a point", 
...
x <- c(1,2,3,4,5)
y <- c(3,2,5,3,7)
png("ex2.png", width = 4, height = 4, units = "in", res = 240)
...
png("ex3.png", width = 4, height = 4, units = "in", res = 240)
...
png("ex4.png", width = 4, height = 4, units = "in", res = 240)
...
png("ex5.png", width = 4, height = 4, units = "in", res = 240)
